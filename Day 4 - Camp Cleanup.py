...
def main():
    ...
    with open("input_files/day4.txt") as file:
        ...
        # Convert n file lines (here n == 4):
        # 1-93,2-11
        # 26-94,26-94
        # 72-92,48-88
        # 36-37,37-52
        # to a list of n lists of 4 integers
        # [[1, 93, 2, 11],
        #  [26, 94, 26, 94],
        #  [72, 92, 48, 88],
        #  [36, 37, 37, 52]]

        lists_of_ints = [[int(nr_str)
                          for range_string in line[:len(line) - 1].split(",")
                          for nr_str in range_string.split("-")]
                         for line in lines]
